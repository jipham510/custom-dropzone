...
var $b657c03155fc27e2$var$defaultOptions = {
   ...
   */ chunkSize: 2097152,
    /**
   * How many chunks should be triggered simultaneously for upload. If `true`, the
   * this will be limited by `parallelUploads`. If set to `false` chunks will be
   ...
   *       .innerHTML
   *
   */ previewTemplate: (0, (/*@__PURE__*/$parcel$interopDefault($b34ac8723931fa1c$exports))),
    /*
            ...
            value: function uploadFiles(files) {
                ...
                this._transformFiles(files, function(transformedFiles) {
                    ...
                    if (files[0].upload.chunked) {
                        ...
                        if (_this.options.parallelChunkUploads === false) handleNextChunk();
                        else {
                            var triggerCount = Math.min(_this.options.parallelChunkUploads === true ? _this.options.parallelUploads : _this.options.parallelChunkUploads, file.upload.totalChunkCount);
                            for(var i = 0; i < triggerCount; i++)handleNextChunk();
                        }
                    } else {
                        var dataBlocks = [];
