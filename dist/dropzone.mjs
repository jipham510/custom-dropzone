...
let $4ca367182776f80b$var$defaultOptions = {
   ...
   *       .innerHTML
   *
   */ previewTemplate: (0, (/*@__PURE__*/$parcel$interopDefault($4885b52a421ff3c1$exports))),
    /*
    ...
    uploadFiles(files) {
        this._transformFiles(files, (transformedFiles)=>{
            ...
            if (files[0].upload.chunked) {
                ...
                if (this.options.parallelChunkUploads === false) handleNextChunk();
                else {
                    const triggerCount = Math.min(this.options.parallelChunkUploads === true ? this.options.parallelUploads : this.options.parallelChunkUploads, file.upload.totalChunkCount);
                    for(let i = 0; i < triggerCount; i++)handleNextChunk();
                }
            } else {
                let dataBlocks = [];
